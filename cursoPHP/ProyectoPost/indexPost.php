...
<main>
    ...
    <details>
      ...
      <p>
        <form action="index.php" enctype="multipart/form-data" method="POST">
          <textarea name="texto" rows="3">Post
          </textarea>
  ...
  <section id="posts">
    ...
    <article>
      <div>
        <img src="<?php $datos['img_usuario'];?>" alt="<?php echo $datos['img_usuario'];?>" width="100" height="100">
        <b> <?php echo $datos['nombre_usuario']; ?></b>
      </div>
      <p>
      <?php echo $datos['texto']; ?>
      </p>
      <img src="<?php $datos['img_post'];?>" alt="<?php echo $datos['img_post'];?>" width="800" height="800">
      </figure>
    </article>
    <?php
      var_dump($datos);
